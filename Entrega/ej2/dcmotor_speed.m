...
switch flag,
  ...
  %%%%%%%%%%
  case 2,
    sys=mdlUpdate(t,x,u,ppv,Tw);

  %%%%%%%%%%%
  % Outputs %
  %%%%%%%%%%%
  case 3,
    sys=mdlOutputs(t,x,u,ppv,Tw);
...
%
x0  = [1 0 0 0]; % Inicializo el estado anterior en 1, 
                 % para que no entre al if u > x(1), 
                 % que se encuentra en mdlUpdate()
...
%=============================================================================
%
function sys=mdlOutputs(t,x,u,ppv,Tw)
% x = [estado anterior , contador , tiempo inicial de ventana , velocidad] 

...
switch flag,
  ...
  %%%%%%%%%%%%%%%%%%%%%%%
  case 4,
    sys=mdlGetTimeOfNextVarHit(t,x,u,R,hmax,A,hini);
...
%
if hini>=hmax
    x0=hmax; % El tanque llego a su nivel máximo y desbordó. 
elseif hini<=0
    x0=0; % Tanque vacío
else
    x0=hini;
...
%=============================================================================
%
function sys=mdlGetTimeOfNextVarHit(t,x,u,R,hmax,A,hini)
